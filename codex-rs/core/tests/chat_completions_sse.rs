// Restored on this fork from `d2394a2494^`. Parked under `cfg(any())` for the
// same reason as `chat_completions_payload.rs`: protocol/API drift since the
// upstream nuke commit. Re-enable test-by-test after end-to-end works.
#![cfg(any())]
